...
import com.gitrose.bukinghotel.adapter.SimpleBaseAdapter;
import com.gitrose.bukinghotel.entity.CalendarData;
import com.gitrose.bukinghotel.util.SpecialCalendarutil;
...
public class MyCalendar extends LinearLayout {
    ...
    private void getWholeMonthDatas(CalendarData data) {
        ...
        mTvYearMouth.setText(String.format("%s년 %s월", String.valueOf(data.year), String.valueOf(data.month)));
    }
...
//    }
        ...
        public View getItemView(final int position, View convertView, final ViewHolder viewHolder) {
            ...
            dayView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.e("myCalender", calendar.year + "년" + calendar.month + "월" + calendar.day);
    ...
    public String getTheDayOfSelectedByRose() {
        if (theDayOfSelected != null) {
            String sYear = String.valueOf(theDayOfSelected.year);
            String sMonth = String.valueOf(theDayOfSelected.month);
            String sDay = String.valueOf(theDayOfSelected.day);
